/*!
* metismenu https://github.com/onokumus/metismenujavascript: void(0);readme
...
var MetisMenu = /*javascript: void(0);__PURE__*/function () {
  // eslint-disable-line no-shadow
  ...
  _proto.init = function init() {
    ...
    .children(conf.triggerElement).on(Event.CLICK_DATA_API, function (e) {
      ...
      if (conf.preventDefault && eTar.attr('href') === 'javascript: void(0);') {
        e.preventDefault();
      }
