@component('mail::message')
    <p style="text-align: center;">
        {{ $user->name }} your <br>
        <strong style="text-transform: uppercase;"> Redeem Replacement Leave</strong>
        Request has been
        <strong style="text-transform: uppercase;">{{ $model->overall_status }}</strong>.
    @if($model['overall_status'] === 'completed')
        <p style="text-align: center;"> Your Replacement leave balance has been updated.</p>
        <p style="text-align: center;"> New Balance added: {{ $model['added_qty'] }} Days</p>
    @endif
    </p>
    <br>
    <p>
